...
const handleSubmit = (e) => {
  ...
  // Include the referral_slug in the form data
  const formDataWithSlug = { ...formData, referral_slug: slug };
  ...
  fetch(apiUrl, {
    ...
    body: JSON.stringify(formDataWithSlug), // Send the updated form data with referral_slug
  })
    .then((response) => {
      if (!response.ok) {
          ...
          <section className="ticket-section">
            ...
            <div className="contact-form ticket-referral-form">
              <form onSubmit={handleSubmit}>
                <h4 className="reg-title">TICKETS FORM </h4>
                <div className="row">
